class MCWorkflowAsTableGroupedComponentController {
    /*@ngInject*/
...
angular.module('materialscommons').component('mcWorkflowAsTableGrouped', {
    template: require('./mc-workflow-as-table-grouped.html'),
    controller: MCWorkflowAsTableGroupedComponentController
});
