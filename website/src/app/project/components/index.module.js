import './display-file-contents-directive';
import './mc-new-process-menu.component';
import './files-list/mc-files-list.component';
//import './processes-list/mc-processes-list.component';
