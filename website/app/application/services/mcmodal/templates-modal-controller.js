(function (module) {
    module.controller('TemplatesModalController', TemplatesModalController);
    TemplatesModalController.$inject = ["project", "templates", "mcmodal", "$modalInstance",
        "Restangular", "User", "processTemplates"];

    function TemplatesModalController(project, templates, mcmodal, $modalInstance, Restangular, User, processTemplates) {
        var ctrl = this;
