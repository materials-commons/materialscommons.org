(function (module) {
    module.directive('homeFilesMediatype', homeFilesMediatypeDirective);
    ...
    module.controller("homeFilesMediatypeDirectiveController", homeFilesMediatypeDirectiveController);
    homeFilesMediatypeDirectiveController.$inject = ["$scope", "$state", "listParams", "searchParams", "ui"];
