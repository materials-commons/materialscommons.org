Application.Controllers.controller("projectSamplesOverview",
                                   ["$scope", "project", "mcapi","$filter","pubsub", projectSamplesOverview]);

function projectSamplesOverview($scope, project, mcapi, $filter, pubsub) {
