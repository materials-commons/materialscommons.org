(function (module) {
    module.directive("processNetworkView", [processNetworkViewDirective]);
    ...
    module.controller("processNetworkViewDirectiveController", processNetworkViewDirectiveController);
    processNetworkViewDirectiveController.$inject = ["$scope", "$timeout", "$state", "pubsub"];
