(function (module) {
    ...
    EditProcessController.$inject = ["Restangular", "processEdit", "selectItems", "$state", "process", "processTemplates"];

    function EditProcessController(Restangular, processEdit, selectItems, $state, process, processTemplates) {
        var ctrl = this;
