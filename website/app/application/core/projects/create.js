Application.Controllers.controller("projectsCreate",
                                   ["$scope", "mcapi", "model.projects",
                                    "current", "$state", projectsCreateController]);
function projectsCreateController($scope, mcapi, Projects, current, $state) {
