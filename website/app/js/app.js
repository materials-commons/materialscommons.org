var app = angular.module('materialscommons',
    ['ui', 'Filter', 'materialsCommonsServices', 'materialsdirective', 'stateServices', 'jqyoui', 'AngularStomp',
        'ui.bootstrap', 'NgTree', 'ngCookies', '$strap.directives', 'ngGrid', 'Provenance', 'ui.router']);
...
//app.config(['$routeProvider', '$locationProvider', '$httpProvider', '$routeSegmentProvider', function ($routeSegmentProvider) {
//    Stomp.WebSocketClass = SockJS;
//    mcglobals = {};
//    doConfig();
//
