class MCDatasetProcessDetailsSetupComponentController {
    /*@ngInject*/
    constructor($filter) {
        this.$filter = $filter;
...
angular.module('materialscommons').component('mcDatasetProcessDetailsSetup', {
    templateUrl: 'app/project/experiments/experiment/components/dataset/mc-dataset-process-details-setup.html',
    controller: MCDatasetProcessDetailsSetupComponentController,
    bindings: {
        processSetup: '<'
    }
});
