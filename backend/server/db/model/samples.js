module.exports = function(r) {
    ...
    function *create(protoSample) {
        let s = new Sample(protoSample.name, protoSample.description, protoSample.owner);
        let sample = yield db.insert('samples', s);
        let p2s = new Project2Sample(protoSample.project_id, sample.id);
        yield db.insert('project2sample', p2s);
