...
const Setup = db.createModel("setups", {
    id: db.type.string(),
    _type: db.type.string().default("settings"),
    name: db.type.string(),
...
const Dataset = db.createModel("datasets", {
    id: db.type.string(),
    _type: db.type.string().default("dataset"),
...
const ExperimentNote = db.createModel("experimentnotes", {
    id: db.type.string(),
    _type: db.type.string().default("note"),
    owner: db.type.string(),
    note: db.type.string(),
    name: db.type.string(),
    birthtime: db.type.date.default(r.now()),
...
const ExperimentTask = db.createModel("experimenttasks", {
    id: db.type.string(),
    _type: db.type.string().default("experiment_task"),
    name: db.type.string(),
    note: db.type.string(),
    owner: db.type.string(),
